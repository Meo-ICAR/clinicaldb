...
/**
 * Mostra le altre app (oggi Dashboard) in cui l'utente loggato ha anche un
 * account, interrogando la loro API /api/users/lookup, e permette di
 * passare con login automatico riusando il bridge SSO (BpmBridgeController
 * + /bpm-landing/{id}) già in produzione tra UnicoBPM e Dashboard.
 */
